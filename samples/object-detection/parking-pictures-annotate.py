...
file = open("assets/train/main_png.txt", "r")
...
print('pinned_car_boxes', pinned_car_boxes)

# Video file or camera to process - set this to 0 to use your webcam instead of a video file
VIDEO_SOURCE = os.path.join(ROOT_DIR, "assets/parking-480.mp4")
...
while video_capture.isOpened():
    ...
    if success:
        ...
        cv2.imwrite('assets/images/new'+ str(frameId)+'.jpg', frame)
